...
import {header,title,navList,navItem,activeNavItem} from "../components/header.module.scss"
...
const Header = () => {
    ...
    return(
        <header className={header}>
            <h1>
                <Link className={title} activeClassName={activeNavItem} to="/">{data.site.siteMetadata.title}</Link>
            </h1>
            <nav>
